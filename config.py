...
class Config(object):
    ...
    OWNER_ID = int(getenv("OWNER_ID", "6627636245"))  # sᴛᴀʀᴛ @Exon_Robot ᴛʏᴘᴇ /id
    OWNER_USERNAME = getenv("OWNER_USERNAME", "SASHIKANT_XD")
    SUPPORT_CHAT = getenv("SUPPORT_CHAT", "VOICEOFHEART0")
    LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1002117074936"))
